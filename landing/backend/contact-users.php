...
if (
	...
	$receiver_email = 'antonyrebolledo@gmail.com';

	// Email Receiver Name for SMTP Email
	$receiver_name 	= 'Boreana';
	...
	$html = '
		...
		<h1 style="margin: 0; color: #000; font-size: 25px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: normal; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><strong>Nuevo mensaje de contacto.</strong></h1>
		</td>
		</tr>
		</table>
		...
		<p style="margin: 0; font-size: 14px; text-align: left; letter-spacing: normal;">Asunto: ' . $subject . '</p>
		<p style="margin: 0; font-size: 14px; text-align: left; letter-spacing: normal;">Correo: ' . $email . ' </p>
		<p style="margin: 0; font-size: 14px; text-align: left; letter-spacing: normal;">Mensaje: ' . $message . ' </p>
		</div>
		</div>
		</td>
		</tr>
